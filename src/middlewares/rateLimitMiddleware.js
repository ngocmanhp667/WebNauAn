...
const loginLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: 'Too Many Requests - Bạn đã đăng nhập quá nhiều lần. Vui lòng thử lại sau 15 phút.'
    },
...
const registerLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: 'Too Many Requests - Bạn đã gửi quá nhiều yêu cầu đăng ký. Vui lòng thử lại sau 15 phút.'
    },
...
const forgotPasswordLimiter = rateLimit({
    ...
    message: {
        success: false,
        message: 'Too Many Requests - Bạn đã gửi quá nhiều yêu cầu. Vui lòng thử lại sau 15 phút.'
    },
    standardHeaders: true,
    legacyHeaders: false,
    handler: (req, res) => {
